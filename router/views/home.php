<html>
	...
	<body>
		...
		<!-- 	<div class="row" id="zoomDiv" style="background-color: yellow">
				<section class="col-lg-3" style="background-color: blue">
				<div id="zoomDisplayPicture" ></div>
				</section>
				<section  class="col-lg-6" style="background-color: red">
				<div id="zoomDisplayDescription" >
				</div>
				</section>
			</div> -->
<!-- to make card -->
